'''Implementar un sintetizador FM con "n" frecuencias moduladoras similar al que se ha visto en clase,
pero que permita controlar en tiempo real (mediante teclado) las frecuencias y los coeficientes β de
las mismas, así como los de la portadora.'''
